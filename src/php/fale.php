...
<form class="form center">
    ...
    <!-- Campo para o usuário inserir seu e-mail -->
    <input type="email" placeholder="Seu e-mail" id="to" class="input" required>

    <!-- Campo para o usuário inserir sua mensagem -->
    <textarea id="message" placeholder="Sua mensagem" class="input" required></textarea>

    <!-- Botão para enviar a mensagem -->
    <button type="button" id ="sendButton"onclick="sendMail();">Enviar</button>
</form>

<script>
document.addEventListener("DOMContentLoaded", function () {
    emailjs.init("zD2R1Bf3fNp00XTWe");

    function sendMail() {
        const userEmail = document.querySelector("#to").value;
        ...
        const serviceID = "service_ahz4ab2";
        const templateID = "template_j3bfbev";
    ...
    document.querySelector("#sendButton").onclick = sendMail;
});
