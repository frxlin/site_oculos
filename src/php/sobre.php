  ...
  <div class="row justify-content-center">
    <div class="col-lg-8 col-md-10 col-sm-12">
      <div class="card text-center shadow-lg">
        <div class="card-body">
          <h1 class="card-title color-text">Quem Somos</h1>
          <hr>
          <p class="card-text  color-text">
            Bem-vindo à nossa loja de óculos! <br>
            Somos apaixonados por oferecer a melhor experiência em produtos ópticos. Nossa missão é proporcionar a você
            qualidade, estilo e conforto em cada par de óculos. Trabalhamos com dedicação para trazer as melhores opções de óculos de grau e óculos de sol, alinhando inovação, tecnologia e as últimas tendências de moda. <br><br>
            Valorizamos o seu bem-estar visual e acreditamos que enxergar bem é essencial para viver melhor. Por isso, garantimos que cada produto seja cuidadosamente selecionado para atender às suas necessidades, unindo funcionalidade e design. <br><br>
            Obrigado por confiar em nós. Explore nosso catálogo e encontre o par de óculos perfeito para você!
          </p>
        </div>
      </div>
    </div>
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  navLinks.forEach(link => {
    ...
    if (href) {
      ...
      console.warn("O elemento não possui um href válido:", link);
    }
  });

  console.log("Script carregado, URL atual:", currentPath);
});
</script>
