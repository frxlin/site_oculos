...
<div class="container mt-4">
  <div class="row">
      ...
      <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="d-block w-100 img-fluid img1" src="../imagens/sol2.png" alt="Primeiro Slide">
          </div>
    ...
    <h2><strong>Óculos de Sol Modelo Reflekt</strong></h2>
      ...
      <div class="d-flex gap-3 flex-wrap lado-lado">
        ...
        <a href="?adicionar=Óculos de Sol Modelo REflekt">
      ...
      <div class="container text-center text-md-start mt-5">
        <div class="row mt-3">
          ...
          <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
            ...
            <p>
              <a href="#!" class="text-reset">Óculos De 8</a>
            </p>
          </div>
